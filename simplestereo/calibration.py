...
def _getCalibrationFlags(n):
    """
    Get flags for calibration from the selected number of parameters.
    
    Selecting distortion coefficients in OpenCV:
    The distortion parameters are the radial coefficients k1, k2, k3, k4, k5, and k6 ,
